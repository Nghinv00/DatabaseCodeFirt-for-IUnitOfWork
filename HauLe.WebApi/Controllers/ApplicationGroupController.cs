...
using HauLe.Common.Exceptions;
using HauLe.Data.Infrastructure;
using HauLe.Model.Models;
using HauLe.Service;
using HauLe.WebApi.App_Start;
using HauLe.WebApi.Infrastructure.Core;
using HauLe.WebApi.Infrastructure.Extensions;
using HauLe.WebApi.Models;

namespace HauLe.WebApi.Api
{
    ...
    public class ApplicationGroupController : ApiControllerBase
    {
        ...
        public ApplicationGroupController(
            ...
            IApplicationGroupService appGroupService) : base()
        {
